...
<% 
	...
	ResultSet resultset4 = statement4.executeQuery("select * from exam");
			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						...
						<form method="post" action="student_add.jsp" class="register-form"
							id="register-form">
							<div class="form-group">
								<label for="prn"><i
									class="zmdi zmdi-account zmdi-accounts-list-alt material-icons-name"></i></label> <input
									type="text" name="prn" id="PRN" placeholder="PRN" />
							</div>
							<div class="form-group">
								<label for="name"><i
							...
							<div class="form-group">
								<label for="email"><i class="zmdi zmdi-email material-icons-name"></i></label> <input
									type="email" name="email" id="email" placeholder="Student Email" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<select name="eid">
									...
									<option value="<%= resultset4.getString("eid") %>"><%= resultset4.getString("ename") %></option>
			    					<% } %>
								</select>
							</div>
							<div class="form-group form-button">
								<input type="submit" name="add" id="add"
									class="form-submit" value="Add Student" />
								<a href="student.jsp" class="btn form-submit" style="text-decoration:none;cursor:pointer;color:white;">Cancel</a>	
							</div>
						</form>
					</div>
