...
<input type="hidden" id="status" value="<%= request.getAttribute("status") %>">
			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						<h2 class="form-title">Add Exam Details</h2>
					
						<form method="post" action="exam_add.jsp" class="register-form"
							id="register-form">
							...
							<!-- <div class="form-group">
								<label for="prn"><i
									...
									type="text" name="cid" id="cid" placeholder="Course ID" />
							</div> -->
							<div class="form-group">
							...
							<div class="form-group">
								<label for="name"><i
									class="zmdi zmdi-collection-text material-icons-name"></i></label> <input
									type="text" name="ename" id="ename" placeholder="Exam Name" />
							</div>
							<div class="form-group form-button">
								<input type="submit" name="add" id="add"
									class="form-submit" value="Add Exam" />
								<a href="exam.jsp" class="btn form-submit" style="text-decoration:none;cursor:pointer;color:white;">Cancel</a>	
							</div>
						</form>
					</div>
	...
	<script>
		...
		if(status == "Success") {
			swal("Congrats","Exam Added Successfully","success");
		}
	</script>
