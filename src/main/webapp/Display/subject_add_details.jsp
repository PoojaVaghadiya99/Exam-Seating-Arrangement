...
<% 
	...
	ResultSet resultset3 = statement3.executeQuery("select * from course");
			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						<h2 class="form-title">Add Subject Details</h2>
						<form method="post" action="subject_add.jsp" class="register-form"
							id="register-form">
							...
							<div class="form-group">
								...
								<select name="cid">
									...
									<option value="<%= resultset3.getString("cid") %>"><%= resultset3.getString("cname") %></option>
			    					<% } %>
								</select>
							</div>
							<div class="form-group">
								<label for="name"><i
									...
									type="text" name="eid" id="eid" placeholder="Exam ID" />
							</div>
							<div class="form-group">
								<label for="prn"><i
									class="zmdi zmdi-account zmdi-accounts-list-alt material-icons-name"></i></label> <input
									type="text" name="sid" id="sid" placeholder="Subject ID" />
							</div>
							<div class="form-group">
								<label for="prn"><i
									class="zmdi zmdi-account zmdi-plus-square material-icons-name"></i></label> <input
									type="text" name="sname" id="sname" placeholder="Subject Name" />
							</div>
							<div class="form-group">
								<label for="prn"><i
									class="zmdi zmdi-account zmdi-calendar-alt material-icons-name"></i></label> <input
									type="date" name="sdate" id="sdate" placeholder="date" />
							</div>
							<div class="form-group">
								<label for="prn"><i
									class="zmdi zmdi-account zmdi-alarm-check material-icons-name"></i></label> <input
									type="time" name="stime" id="stime" placeholder="time" />
							</div>
							<div class="form-group form-button">
								<input type="submit" name="add" id="add"
									class="form-submit" value="Add Subject" />
								<a href="subject.jsp" class="btn form-submit" style="text-decoration:none;cursor:pointer;color:white;">Cancel</a>	
							</div>
						</form>
					</div>
