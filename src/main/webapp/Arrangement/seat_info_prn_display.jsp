            ...
            <div class="card">
                <div class="card-body p-0">
                    <div class="row p-5">
                        ...
                        <div class="col-md-6 text-right"><br><br><br><br>
                            <h4 class="font-weight-bold mb-1"><% while(rs2.next()) { %>  <%= rs2.getString("fname") %> <% } %><br></h4>
                            <p class="text-muted"><% while(rs3.next()) { %> <%= rs3.getString("dname") %><% } %><br></p>
                        </div>
                   ...
                   <hr> 
                    ...
                    <div class="row pb-5 p-5">
                        <div class="col-md-8">
                            ...
                            <p class="mb-1"><b>Exam Name - </b><% while(rs4.next()) { %> <%= rs4.getString("ename") %>  <% } %></p>
                            <p class="mb-1"><b>Course Name - </b><% while(rs5.next()) { %> <%= rs5.getString("cname") %>  <% } %></p>
                            <p class="mb-1"><b>Block Name (ID) - </b><% while(rs7.next()) { %>  <%= rs7.getString("bname") %>  <% } %>(<%= rs1.getString(6) %>)</p>
                            <p class="mb-1"><b>Seat No - </b><%= rs1.getInt(7) %></p>
                        </div>
				
                        <div class="col-md-4 text-left">
                        <% while(rs6.next()) { %> 
                            <p class="font-weight-bold mb-4">Payment Details</p>
                            <p class="mb-1"><span class="text-muted"><b>PRN - </b></span> <%= rs6.getString("prn") %></p>
                            <p class="mb-1"><span class="text-muted"><b>Name - </b></span> <%= rs6.getString("name") %></p>
                            <p class="mb-1"><span class="text-muted"><b>Email - </b></span> <%= rs6.getString("email") %></p>
                            <p class="mb-1"><span class="text-muted"><b>Phone No - </b></span>  <%= rs6.getString("phone") %> </p>
                            <% } %>
                        </div>
                    </div>
